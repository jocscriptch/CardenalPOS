    ...
    public function registrarCotizacion()
    {
        ...
        if (!empty($datos['productos'])) {
            ...
            if (empty($idCliente)) {
                ...
                $res = array('msg' => 'VALIDEZ REQUERIDA', 'type' => 'warning');
            } else {
                ...
                $cotizacion = $this->model->registrarCotizacion(
                    $datosProductos,
                    $subtotal,
                    $iva,
                    $granTotal,
                ...
                if ($cotizacion > 0) {
                    $res = array('msg' => 'COTIZACION REGISTRADA', 'type' => 'success', 'idCotizacion' => $cotizacion);
                } else {
                    $res = array('msg' => 'ERROR AL CREAR COTIZACION', 'type' => 'error');
                }
            }
        } else {
