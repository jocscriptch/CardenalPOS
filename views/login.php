                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="<?php echo BASE_URL; ?>assets/images/login_logo.png" width="380" alt="0" />
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="login-separater text-center mb-4"> <span>INICIAR SESIÓN CON EL CORREO
                                            ELECTRÓNICO</span>
                                        <hr />
                                    </div>
                                    <div class="form-body">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary"><i
                                                            class="bx bxs-lock-open"></i>Iniciar Sesión</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
