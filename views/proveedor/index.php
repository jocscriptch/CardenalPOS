    ...
    <div class="card-body">
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-auto">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="dropdown-item" href="<?php echo BASE_URL . 'proveedor/inactivos'; ?>">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-proveedores-tab" data-bs-toggle="tab"
                    data-bs-target="#nav-proveedores" type="button" role="tab" aria-controls="nav-proveedores"
                    aria-selected="true">Proveedores</button>
                <button class="nav-link" id="nav-nuevo-tab" data-bs-toggle="tab" data-bs-target="#nav-nuevo"
                    type="button" role="tab" aria-controls="nav-nuevo" aria-selected="false">Nuevo Proveedor</button>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-proveedores" role="tabpanel"
                aria-labelledby="nav-proveedores-tab">
                <h5 class="card-title text-center "><i class="fas fa-users me-2"></i></i>Lista de Proveedores Activos
                </h5>
                <hr>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover align-middle nowrap"
                        id="tblProveedores" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Nombre</th>
                                <th>Telefono</th>
