    ...
    <div class="card-body">
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-auto">
                ...
                <i class="fa-solid fa-circle-plus fa-bounce fa-2xl" style="color: #008cff;"></i>
                </a>
                
                <ul class="dropdown-menu">
                    <li>
                        <a class="dropdown-item" href="#" id="nuevoAbono">
                            <i class="fas fa-colon-sign me-2"></i>Abonos
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-creditos-tab" data-bs-toggle="tab"
                    data-bs-target="#nav-creditos" type="button" role="tab" aria-controls="nav-creditos"
                    aria-selected="true">Créditos</button>
                <button class="nav-link" id="nav-abonos-tab" data-bs-toggle="tab" data-bs-target="#nav-abonos"
                    type="button" role="tab" aria-controls="nav-abonos" aria-selected="false">Abonos</button>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-creditos" role="tabpanel"
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover align-middle nowrap" id="tblCreditos"
                        style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Fecha</th>
            ...
            <div class="tab-pane fade p-3" id="nav-abonos" role="tabpanel" aria-labelledby="nav-abonos-tab">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover align-middle nowrap" id="tblAbonos"
                        style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Fecha</th>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item" id="clienteDireccion"><i class="fas fa-home"></i></li>
                        </ul>
                    </div>
