...
<body>
        ...
        <tr>
            ...
            <td class="info-compra">
                <div class="container-factura">
                    <span class="factura">Crédito</span>
                    <p>N°: <strong>
                            <?php echo $data['credito']['id']; ?>
                        </strong></p>
                    <p>Fecha:
                        <?php echo $data['credito']['fecha']; ?>
                    </p>
                    <p>Hora:
                        <?php echo $data['credito']['hora']; ?>
                    </p>
                </div>
            </td>
        </tr>
    ...
    <table id="container-info">
        <tr>
            <td>
                <strong>
                    <?php echo $data['credito']['identidad'] ?>
                </strong>
                <p>
                    <?php echo $data['credito']['num_identidad'] ?>
                </p>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <p>
                    <?php echo $data['credito']['nombre'] ?>
                </p>
            </td>
            <td>
                <strong>Teléfono: </strong>
                <p>
                    <?php echo $data['credito']['telefono'] ?>
                </p>
            </td>
            <td>
                <strong>Dirección: </strong>
                <p>
                    <?php echo $data['credito']['direccion'] ?>
                </p>
            </td>
        </tr>
    </table>
    ...
    <table id="container-producto">
        ...
        <tbody>
            ...
            <tr class="total">
                <td class="text-right" colspan="3">Monto Total</td>
                <td class="text-right">
                    <?php echo number_format($data['credito']['monto'], 2); ?>
                </td>
            </tr>
        </tbody>
    </table>
        ...
        <tbody>
            ...
            foreach ($data['abonos'] as $abono) {
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <?php echo number_format($abono['abono'], 2); ?>
                    </td>
                </tr>
            <?php } ?>
            ...
            <tr class="total">
                ...
                <td class="text-right">
                    <?php echo number_format($abonado, 2); ?>
                </td>
            </tr>
            ...
            <tr class="total">
                ...
                <td class="text-right">
                    <?php echo number_format($data['credito']['monto'] - $abonado, 2); ?>
                </td>
            </tr>
