                    ...
                    <div class="col-md-12">
                        <div class="btn-group btn-group-toggle mb-2" data-toggle="buttons">
                            ...
                            <label class="btn btn-info">
                                <input type="radio" id="nombre" name="buscarProducto">
...
<div id="modalProcesar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Procesar Apartado</h5>
                <button class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="d-grid">
                    <button class="btn btn-info" type="button" id="btnProcesar">Procesar</button>
                </div>
            </div>
        </div>
    </div>
