    ...
    <div class="card-body">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-medidas-tab" data-bs-toggle="tab" data-bs-target="#nav-medidas"
                    type="button" role="tab" aria-controls="nav-med idas" aria-selected="true">Medidas</button>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-medidas" role="tabpanel"
                ...
                <h5 class="card-title text-center "><i class="fa-solid fa-list-check me-2"></i></i>Listado de Medidas</h5>
                <hr>
